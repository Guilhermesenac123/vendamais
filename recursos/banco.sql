...
('Pamela', '777.777.777-77', '(44)97777-7777', 'Rua Nova Olimpia', 500, 'Centro', 'pamela@gmail.com', 'Gerente', '4.500',2)
...
CREATE TABLE venda(
    ...
    INSERT INTO venda(obs, valor_total, quantidade_total, cliente_id, funcionario_id)VALUES ('Venda com pendência', 50, 10, 1, 1);
...
CREATE TABLE item_venda( id INT AUTO_INCREMENT PRIMARY KEY, quantidade INT, valor DECIMAL(10,2), 
venda_id INT, produto_id INT, FOREIGN KEY (venda_id) REFERENCES venda(id), FOREIGN KEY (produto_id) REFERENCES produto(id) );
